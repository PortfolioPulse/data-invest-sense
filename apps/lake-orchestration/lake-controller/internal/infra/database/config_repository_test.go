...
//           },
//      }
//      config1, err := entity.NewConfig("test", true, "daily", "test", "test", "test", dependsOn1, jobParams1, serviceParams1)
//      suite.NoError(err)
...
//           },
//      }
//      config2, err := entity.NewConfig("test", true, "daily", "test", "test", "test", dependsOn2, jobParams2, serviceParams2)
//      suite.NoError(err)
